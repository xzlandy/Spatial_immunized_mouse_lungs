...
setwd('~/Box/RWorkSpace/Spatial_combine/CellChat/scATAC/')

load('../../Integration/T_cells/tcell.RData')
...
# 
# save(cellchat, file = 'scATAC_cellchat.RData')
load('scATAC_cellchat.RData')
